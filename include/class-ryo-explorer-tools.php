<?php
/**
 * ryo_explorer_tools.php
 *
 * Uses CURL to call API functions from the block explorer
 * https://explorer.ryo-currency.com/api
 *
 * @author Serhack
...
class Ryo_Explorer_Tools
{
    private $url;
    public function __construct($testnet = false)
    {
        $this->url = $testnet ? RYO_GATEWAY_TESTNET_EXPLORER_URL : RYO_GATEWAY_MAINNET_EXPLORER_URL;
    }
