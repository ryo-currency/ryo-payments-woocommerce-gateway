...
require_once('class-ryo-base58.php');

class Ryo_Cryptonote
{
    protected $ed25519;
    public function __construct()
    {
        $this->ed25519 = new ed25519();
        $this->base58 = new Ryo_base58();
        $this->address_prefix = RYO_GATEWAY_ADDRESS_PREFIX; // RYoL
        $this->address_prefix_integrated = RYO_GATEWAY_ADDRESS_PREFIX_INTEGRATED; // RYoN
    }
    ...
    /*
     * Create a valid base58 encoded Ryo address from public keys
     *
     * @param string Public spend key
     * @param string Public view key
     *
     * @return string Base58 encoded Ryo address
     */
...
/*
 * Decode a base58 encoded Ryo address
 *
 * @param string A base58 encoded Ryo address
 *
 ...
 */
    ...
    /*
     * Generate a Ryo address from seed
     *
     * @param string Hex string to use as seed
     *
     * @return string A base58 encoded Ryo address
     */
