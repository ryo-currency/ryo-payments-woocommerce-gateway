<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    <tr>
        <td>Exchange rate</td>
        <td>1 Ryo = <?php echo $details['rate_formatted'].' '.$details['currency']; ?></td>
    </tr>
    <tr>
        <td>Total amount</td>
        <td><?php echo $details['amount_total_formatted']; ?> Ryo</td>
    </tr>
    <tr>
        <td>Total paid</td>
        <td><?php echo $details['amount_paid_formatted']; ?> Ryo</td>
    </tr>
    <tr>
        <td>Total due</td>
        <td><?php echo $details['amount_due_formatted']; ?> Ryo</td>
    </tr>
    <tr>
        <td>Order age</td>
        <td><?php echo Ryo_Gateway::format_seconds_to_time($details['order_age']) ?> ago</td>
    </tr>
    <tr>
...
<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    ...
    <tr>
        <td>
            <a href="<?php echo RYO_GATEWAY_EXPLORER_URL.'/tx/'.$tx['txid']; ?>" target="_blank"><?php echo $tx['txid']; ?></a>
        </td>
        <td><?php echo $tx['height']; ?></td>
        <td><?php echo sprintf(RYO_GATEWAY_ATOMIC_UNITS_SPRINTF, $tx['amount'] / RYO_GATEWAY_ATOMIC_UNITS_POW); ?> Ryo</td>
    </tr>
    <?php endforeach; ?>
</table>
<?php endif; ?>
